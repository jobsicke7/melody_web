...
declare global {
  var _mongoClientPromise: Promise<MongoClient> | undefined; // MongoClientType 대신 MongoClient 사용
  var _mongooseConnection: MongooseConnection;
}

let clientPromise: Promise<MongoClient>; // MongoClientType 대신 MongoClient 사용
